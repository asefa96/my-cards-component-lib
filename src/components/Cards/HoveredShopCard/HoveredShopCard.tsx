...
import "./HoveredShopCard.scss";
import { HoveredShopCardType } from "./HoveredShopCard.types.";

const HoveredOpenCard:FC<HoveredShopCardType> = (props:HoveredShopCardType) => {
  return (
    <>
      <section className="cards__shop">
        <article className="card__shop card--1">
